        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body">
                    <b>Informasi</b>
                    <hr>
                    Pembeli : {{$model->pelanggan->nama}} <br>
                    ...
                    @if ($model->status == 0 && \Auth::user()->type == 1)
                        <br> <br>
                        <a href="{{route('admin.penjualan.lunas', $model->id)}}" class="btn btn-block btn-primary btn-sm">Buat Lunas</a>
